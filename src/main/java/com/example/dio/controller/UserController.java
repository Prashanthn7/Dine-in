...
public class UserController {
    ...
    @Operation(description = """
            The API Endpoint is to register the user
            The Endpoint requires user to select one of the specified role along with
            the other details.
            """,
    ...
    @Operation(description = """
            The API Endpoint is to find The User
            The Endpoint  requires user to type the userId of the user
    ...
    @Operation(description = """
            The API Endpoint is to Update The User
            The Endpoint  requires user to type the userId with the user details
            to be Updated.
            """)
